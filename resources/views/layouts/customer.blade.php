				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+91) 9775435716" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+91) 9775435716</a>
								</li>
							</ul>
						</div>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="https://mybazar.online/mybazar_online.png" alt="mercado"></a>
						</div>
                                    ...
                                    <div class="wrap-contact-detail">
                                        <ul>
                                            <li>
                                                ...
                                                <p class="contact-txt">45 Grand Central Terminal Kolkata,IN 700012</p>
                                            </li>
                                            <li>
                                                <i class="fa fa-phone" aria-hidden="true"></i>
                                                <p class="contact-txt">(+91) 9775435716</p>
                                            </li>
                                            <li>
                                                <i class="fa fa-envelope" aria-hidden="true"></i>
                                                <p class="contact-txt">contact@mybazar.com</p>
                                            </li>											
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="wrap-footer-item">
                                ...
                                <div class="item-content">
                                    <div class="wrap-hotline-footer">
                                        ...
                                        <b class="phone-number">1800 12345678</b>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="wrap-footer-item twin-item">
                                    ...
                                    <div class="item-content">
                                        <div class="wrap-vertical-nav">
                                            <ul>
                                                <li class="menu-item"><strong><a href="/vendorReg" class="link-term">Business With Us</a><strong></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
